...
var _parseTransition = _interopRequireDefault(require("../parseTransition"));
...
describe('parseTransition utils', function () {
  it('parseTransition should return an object', function () {
    ...
    var transitionList = (0, _parseTransition.default)('height .35s ease .35s');
    expect(transitionList).toEqual(objectTest);
  });
  it('parseTransition should return a array list with string', function () {
    var transitionList = (0, _parseTransition.default)('height .35s ease');
  ...
  it('should return an array with 3 transition meta data', function () {
    ...
    expect((0, _parseTransition.default)(transition)).toEqual([{
      property: 'opacity',
      duration: 200,
  ...
  it('parseTransition should return an empty array', function () {
    expect((0, _parseTransition.default)().length).toBe(0);
  });
