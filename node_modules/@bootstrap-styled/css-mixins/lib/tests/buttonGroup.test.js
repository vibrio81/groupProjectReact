...
describe('bootstrap buttonGroup utility', function () {
  it('should return a buttonGroup utility css', function () {
    var css = (0, _buttonGroup.buttonGroup)(_buttonGroup.defaultProps['$enable-shadows'], _buttonGroup.defaultProps['$enable-rounded'], _buttonGroup.defaultProps['$input-btn-border-width'], _buttonGroup.defaultProps['$btn-padding-x'], _buttonGroup.defaultProps['$btn-active-box-shadow'], _buttonGroup.defaultProps['$btn-padding-x-lg'], _buttonGroup.defaultProps['$btn-padding-y-lg'], _buttonGroup.defaultProps['$font-size-lg'], _buttonGroup.defaultProps['$btn-border-radius-lg'], _buttonGroup.defaultProps['$btn-padding-x-sm'], _buttonGroup.defaultProps['$btn-padding-y-sm'], _buttonGroup.defaultProps['$font-size-sm'], _buttonGroup.defaultProps['$btn-border-radius-sm']);
