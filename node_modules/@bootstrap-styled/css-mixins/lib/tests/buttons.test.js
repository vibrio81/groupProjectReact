...
describe('bootstrap button mixins', function () {
  ...
  it('buttonVariant should return a css with shadows', function () {
    ...
    expect((0, _immutable.fromJS)({
      css: css
    }).hashCode()).toEqual(-276107851);
  });
  it('buttonVariant should return a css with gradient colors', function () {
    var css = (0, _buttons.buttonVariant)(!_buttons.defaultProps['$enable-shadows'], '#f00', 'linear-gradient(#B21255, #790A68)', '#0ff', _buttons.defaultProps['$btn-active-box-shadow'], false);
    expect(css).not.toContain('undefined');
    expect(css).not.toContain('null');
    expect((0, _immutable.fromJS)({
      css: css
    }).hashCode()).toEqual(989192686);
  });
  it('buttonVariant should return a css by default', function () {
    var css = (0, _buttons.buttonVariant)();
    expect((0, _immutable.fromJS)({
      css: css
    }).hashCode()).toEqual(461863357);
  });
